...
# create the correct filepath for retrieving the 4D fmri file for a particular subject and condition
...
with open('dict_faces_perception_roi_17_18_19_1.json', 'w') as fp:
    json.dump(dict_faces_perception, fp)
with open('dict_faces_perception_roi_17_18_19_1.json', 'r') as fp:
...
#with open('dicts/dict_faces_perception_roi_17_18_19_1.json') as fp:
...
lst = [item[:2,:100] for item in all_data[:3]]
print(lst[0].shape)
print(len(lst))        
print("data i processed into right format, with scaling, will begin hyperalignment")
